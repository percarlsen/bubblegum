...
})({"21C8p":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "6aef5a355405db9b";
"use strict";
...
},{}],"lsY68":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _auto = require("chart.js/auto");
var _autoDefault = parcelHelpers.interopDefault(_auto);
(async function() {
    const element = document.getElementById("ignite-matrix");
    if (!element) // TODO: indicates an error in the HTML (missing element). Deal with that.
    return;
    const data = await getMatrixData();
    new (0, _autoDefault.default)(element, {
        type: "scatter",
        data: {
            datasets: [
                {
...
},{}]},["21C8p","lsY68"], "lsY68", "parcelRequire30ab")

//# sourceMappingURL=index.5405db9b.js.map
